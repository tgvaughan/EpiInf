...
#plotTraj("SIS_psiSamp_Inference.traj", col=rgb(0,0,0,0.2), main="SIS", includeFinalState=T)
...
plotTraj("BD_psiSamp_Inference.traj", col=rgb(0,0,0,0.05), main="BD", includeFinalState=T, burnin=0.1)
