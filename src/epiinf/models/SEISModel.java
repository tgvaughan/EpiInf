...
/**
 * General stochastic SEIS model of an epidemic.
 *
 * @author Tim Vaughan <tgvaughan@gmail.com>
 */
public class SEISModel extends EpidemicModel {
    ...
    public Input<RealParameter> activationRateInput = new Input<>(
            "activationRate", "Activation rate.", Validate.REQUIRED);
    ...
    public EpidemicState getInitialState() {
        return new EpidemicState(S0Input.get().getValue(), 1, 0, 0);
    }
    ...
    public void calculateModelSpecificPropensities(EpidemicState state) {
        ...
        propensities.put(EpidemicEvent.Type.ACTIVATION,
                activationRateInput.get().getValue()*state.E);
